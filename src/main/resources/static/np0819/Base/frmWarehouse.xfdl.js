(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_search", "absolute", "20", "50", null, "42", "20", null, this);
            obj.set_taborder("15");
            obj.style.set_border("1 solid lightskyblue");
            this.addChild(obj.name, obj);
            obj = new Static("st_region", "absolute", "20", "11", "65", "21", null, null, this.div_search);
            obj.set_taborder("3");
            obj.set_text("지역");
            obj.style.set_align("right middle");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("st_country", "absolute", "233", "11", "65", "21", null, null, this.div_search);
            obj.set_taborder("4");
            obj.set_text("국가");
            obj.style.set_align("right middle");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("st_location", "absolute", "462", "10", "65", "21", null, null, this.div_search);
            obj.set_taborder("5");
            obj.set_text("창고위치");
            obj.style.set_align("right middle");
            this.div_search.addChild(obj.name, obj);
            obj = new Combo("cbo_region", "absolute", "93", "10", "100", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            obj.set_taborder("0");
            ...
            obj.set_index("-1");
            obj = new Combo("cbo_country", "absolute", "306", "10", "100", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            obj.set_taborder("1");
            obj.set_displaynulltext("-전체-");
            obj.style.set_displaynulltextcolor("black");
            ...
            obj.set_index("-1");
            obj = new Combo("cbo_location", "absolute", "535", "10", "100", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            obj.set_taborder("2");
            obj.set_displaynulltext("-전체-");
            obj.style.set_displaynulltextcolor("black");
            ...
            obj.set_taborder("16");
            this.addChild(obj.name, obj);
            obj = new Button("dtn_reset", "absolute", "490", "9", "28", "21", null, null, this.div_top);
            obj.set_taborder("0");
            ...
            obj = new Button("btn_delete", "absolute", "706", "9", "60", "21", null, null, this.div_top);
            obj.set_taborder("1");
            obj.set_text("삭제");
            obj.style.set_background("steelblue");
            obj.style.set_color("aliceblue");
            obj.style.set_cursor("hand");
            this.div_top.addChild(obj.name, obj);
            obj = new Button("btn_save", "absolute", "644", "9", "60", "21", null, null, this.div_top);
            obj.set_taborder("2");
            obj.set_text("저장");
            obj.style.set_background("steelblue");
            obj.style.set_color("aliceblue");
            obj.style.set_cursor("hand");
            this.div_top.addChild(obj.name, obj);
            obj = new Button("btn_addRow", "absolute", "582", "9", "60", "21", null, null, this.div_top);
            obj.set_taborder("3");
            obj.set_text("추가");
            obj.style.set_background("steelblue");
            obj.style.set_color("aliceblue");
            obj.style.set_cursor("hand");
            this.div_top.addChild(obj.name, obj);
            obj = new Button("btn_search", "absolute", "520", "9", "60", "21", null, null, this.div_top);
            obj.set_taborder("4");
            obj.set_text("조회");
            obj.style.set_background("steelblue");
            obj.style.set_color("aliceblue");
        ...
        // User Script
        this.registerScript("frmWarehouse.xfdl", function(exports) {
        /***************************************************
        * 화면 id: 창고 목록
        * 작성자: 김현주
        * 작성일자: 2024-09-10
        ...
        ****************************************************/
        this.div_top_btn_addRow_onclick = function(obj,e)
        {
            ...
            var regionValue = this.ds_regionGrd.getColumn(0, "REGION_NAME"); 
            this.ds_warehouse.setColumn(newRow, "REGIONS", regionValue);
                
            var countryValue = this.ds_countriesGrd.getColumn(0, "COUNTRY_NAME"); 
            this.ds_warehouse.setColumn(newRow, "COUNTRIES", countryValue);
               
            var locationValue = this.ds_locationGrd.getColumn(0, "ADDRESS");
            this.ds_warehouse.setColumn(newRow, "LOCATIONS", locationValue);
        ...
        this.div_top_btn_save_onclick = function(obj,e)
        {
            ...
            for (var i = 0; i < this.ds_warehouse.rowcount; i++) {
                ...
                if (!region || region == "- 선택 -") {
                    alert("지역을 선택해 주세요.");
                    rowposition = i;
                    this.ds_warehouse.set_rowposition(rowposition);
                    return;
                }

                if (!country || country == "- 선택 -") {
                    alert("국가를 선택해 주세요.");
                    rowposition = i;
                    this.ds_warehouse.set_rowposition(rowposition);
                    return;
        ...
        ****************************************************/
        ...
        this.loadIncludeScript("frmWarehouse.xfdl", true);
